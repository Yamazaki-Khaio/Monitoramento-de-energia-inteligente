...
from servidor import read_database
...
print(f"O id do seu Medidor foi criado e para acessar os dados do medidor basta acessar: http://localhost:5000/?id={client_id}")
...
while True:
    # Aguarda a entrada do usuário para ajustar o incremento
    limite_alerta = args.limite_alerta
    multiplicador = args.multiplicador
    consumo_atual_kWh = random.randint(1, 500)
